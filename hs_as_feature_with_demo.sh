...
for N_TRAIN_SHOT in 64 128 256 512 1024; do
    ...
    python3 hs_as_feature_with_demo.py \
        ...
        --n_demo_shot ${N_DEMO_SHOT} \
        --seed ${SEED} \
        --output_dir ./output/hs_as_feature_with_demo_all/${LLM} \
        --feature_choose all
    done
done

done
# nohup bash hs_as_feature_with_demo.sh 2>&1 >output/hs_as_feature_with_demo/hs_as_feature_with_demo.log &
# nohup bash hs_as_feature_with_demo.sh 2>&1 >output/hs_as_feature_with_demo_all.log &