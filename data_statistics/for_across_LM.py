...
# KB results 
result = f'./output/across_LM_size/hs_as_feature_with_demo/{MODEL}/results_hs_as_feature.csv'
...
# icl results
icl_results = [f'./output/across_LM_size/icl/{MODEL}/results_icl_{dataset}.csv' for dataset in DATASETS]
...
# KNN results
knn_results = f'./output/across_LM_size/knn_prompting/{MODEL}/results_knnprompting.csv'
...
# knn-prompt results
prompt_results = f'./output/across_LM_size/knn-prompt/{MODEL}/results_knnprompt.csv'
