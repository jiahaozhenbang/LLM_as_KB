...
def main():
    ...
    chosen_feature_indexes = get_fuzzy_label_ids(model, tokenizer, id2verb, k=1)
    test_x = [sum(all_feature[0, chosen_feature_indexes].cpu().numpy().tolist() )for all_feature in dev_pred]

    file = f'data_statistics/SFC_{args.dataset}_demo_{args.n_demo_shot}.npy'
