...
```
python ~/model/convert_llama_weights_to_hf.py \
    --input_dir ~/model/llama --model_size 7B --output_dir ~/model/llama-hf/llama-7B
python ~/model/convert_llama_weights_to_hf.py \
    --input_dir ~/model/llama --model_size 13B --output_dir ~/model/llama-hf/llama-13B
python ~/model/convert_llama_weights_to_hf.py \
    --input_dir ~/model/llama --model_size 30B --output_dir ~/model/llama-hf/llama-30B
python ~/model/convert_llama_weights_to_hf.py \
    --input_dir ~/model/llama --model_size 65B --output_dir ~/model/llama-hf/llama-65B
```
...
def write_tokenizer(tokenizer_path, input_tokenizer_path):
    ...
    tokenizer = tokenizer_class(input_tokenizer_path, legacy=False)
