...
#         --seed ${SEED} \
#         --output_dir ./output/probs_fuzzy_with_demo/${LLM} \
#         --no_StandardScaler 0 \
#         --feature_choose fuzzy_label

for DATASET in dbpedia mr rte trec; do
# DATASET=dbpedia
...
# nohup bash probs_fuzzy_with_demo.sh 2>&1 >output/probs_fuzzy_with_demo.log &