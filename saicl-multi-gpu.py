...
def main():
    ...
    for seed in range(args.n_seed):
        ...
        logger.info(f"===== {args.dataset} / {args.n_train_shot} / {seed} =====")
        ...
        # Stage1: Meta Test
        train_data.subsamplebyshot(args.n_demo_shot, seed)
        prompt_prefix = make_prompt(train_data, args.dataset, mode='train')
        anchor_data.subsamplebyshot(args.n_anchor_shot, seed, exclude=train_data.data)
