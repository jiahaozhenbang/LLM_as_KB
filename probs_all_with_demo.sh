...
# SEED=1
# N_DEMO_SHOT=1
# python3 probs_as_feature_with_demo.py \
#         --llm_dir ${LLM_DIR} \
#         --dataset ${DATASET} \
#         --data_dir ${DATA_DIR} \
...
#         --seed ${SEED} \
#         --output_dir ./output/probs_all_with_demo/${LLM} \
#         --no_StandardScaler 0 \
#         --feature_choose all


for DATASET in  rte trec; do # sst2 subj mpqa agnews cb cr dbpedia 
# DATASET=dbpedia
...
for N_TRAIN_SHOT in 4 8 16 32 64 128 256 512 1024; do
    ...
    python3 probs_all_with_demo.py \
        --llm_dir ${LLM_DIR} \
        --dataset ${DATASET} \
        --data_dir ${DATA_DIR} \
        --n_train_shot ${N_TRAIN_SHOT} \
...
# nohup bash probs_all_with_demo.sh 2>&1 >./output/probs_all_with_demo.log &